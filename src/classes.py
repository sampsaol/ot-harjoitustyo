...
class Classes:
    ### A class that generates the playstyle that the player will be using, or in other words the players class

    def __init__(self):
        ### The constructor where the list of playable classes is defined. The constructor also pseudorandomly chooses a class from the list
